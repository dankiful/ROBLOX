...
if game.PlaceId ~= 8737602449 and game.Players.Localplayer.Name ~= "CloutRats" then
    return
end
...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/dankiful/roblox/main/ok.lua'))()")
